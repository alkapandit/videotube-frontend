...
const SideNavbar = ({ isCollapsed = false, onToggle }) => {
  ...
  return (
    <div
      className={`fixed left-0 top-0 h-full bg-gray-900/95 backdrop-blur-xl border-r border-gray-800 shadow-2xl transition-all duration-300 z-40 ${
        ...
        <div className="p-4 border-t border-gray-800">
          ...
          >
            ...
            {!isCollapsed && !isLoading && (
              <span className="ml-3 group-hover:text-red-400 transition-colors duration-200">
                Logout
              </span>
            )}
            {!isCollapsed && isLoading && (
